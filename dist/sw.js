 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */li();const D={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},lt="admin-delivery-push-v1",gi=[{"revision":"2f6bd6f1feb04dee50a613c8bcc68150","url":"offline.html"},{"revision":"f7654f76a5c347ff2ebabffe8a33cff2","url":"manifest.webmanifest"},{"revision":"f24c650b39c828fba2635f3a3bdbb37d","url":"index.html"},{"revision":"a2b1b48474908a1739aba3cb1bdcb459","url":"icons/maskable-512x512.png"},{"revision":"8a13468f86d27326ee99425a41daa5b9","url":"icons/maskable-192x192.png"},{"revision":"1e01ca630779bb874a4a3de3e8761142","url":"icons/image.png"},{"revision":"0af328c04575d03d55fcc1eaf0d70468","url":"icons/icon-96x96.png"},{"revision":"b81f0934e5a5eb7d3f3a731d983136f4","url":"icons/icon-72x72.png"},{"revision":"b88244b236ae5b32d418dbff3d58040a","url":"icons/icon-512x512.png"},{"revision":"78544fb345bdf1afa96fd8806e157c39","url":"icons/icon-384x384.png"},{"revision":"d580d1e287fda06a62e00c506deaa957","url":"icons/icon-192x192.png"},{"revision":"2c95ff24d0fa43bf03ab4004d6a9b01c","url":"icons/icon-180x180.png"},{"revision":"5a71f5159fea7b88be38e74410950afe","url":"icons/icon-152x152.png"},{"revision":"cca7d2564a1aa36c37975438aaa11445","url":"icons/icon-144x144.png"},{"revision":"80fbffde59eaef42b0ffbc1f247ba116","url":"icons/icon-128x128.png"},{"revision":null,"url":"assets/notificationsService-DYlnXepS.js"},{"revision":null,"url":"assets/index-CleYtb5d.css"},{"revision":null,"url":"assets/index-CZDNVk_J.js"},{"revision":null,"url":"assets/NotificationsPage-i70sb83R.js"}].map(e=>e.url);self.addEventListener("install",e=>{e.waitUntil(caches.open(lt).then(t=>t.addAll(gi)).then(()=>self.skipWaiting()))});self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(t=>Promise.all(t.filter(n=>n!==lt).map(n=>caches.delete(n)))).then(()=>self.clients.claim()))});self.addEventListener("fetch",e=>{e.request.method!=="GET"||new URL(e.request.url).origin!==self.location.origin||e.respondWith(fetch(e.request).catch(()=>caches.match(e.request).then(t=>t||caches.match("/index.html"))))});if(D.apiKey&&D.projectId&&D.messagingSenderId&&D.appId){const e=hi(Fe(D));pi(e,t=>{const n=t.data||{},r=n.title||"Nova notificação";self.registration.showNotification(r,{body:n.body,image:n.image_url||void 0,icon:"/icons/icon-192x192.png",data:n})})}self.addEventListener("notificationclick",e=>{var r;e.notification.close();const t=String(((r=e.notification.data)==null?void 0:r.route)||"/notifications"),n=new URL(t,self.location.origin).href;e.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(async i=>{const o=i[0];return o?(await o.navigate(n),o.focus()):self.clients.openWindow(n)}))});
